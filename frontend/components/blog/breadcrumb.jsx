...
const Breadcrumb = ({data}) => {
    ...
    return (
        <nav className="flex my-5 p-4" aria-label="Breadcrumb">
            <ol className="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div className="flex items-center">
                        ...
                        <Link href="/blog" locale={router.locale}>
                            <a className="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Blog</a>
                        </Link>
                    </div>
                </li>
                <li aria-current="page">
                    <div className="flex items-center">
                        ...
                        <Link href={data[2][1]} locale={router.locale}>
                            <a>
                               <span className="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-400">{data[2][0]}</span>
                            </a>
                        </Link>
                    </div>
                </li>
